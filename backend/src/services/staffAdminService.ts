...
export class StaffAdminService {
  ...
  async getRestaurantStaff(restaurantId: string) {
    try {
      ...
      Logger.error('Error fetching restaurant staff', { restaurantId, error: error instanceof Error ? { name: error.name, message: error.message, stack: error.stack } : undefined });
      throw error;
    }
  }
  ...
  async inviteStaff(input: InviteStaffInput) {
    try {
      ...
      Logger.error('Error inviting staff', { input, error: error instanceof Error ? { name: error.name, message: error.message, stack: error.stack } : undefined });
      throw error;
    }
  }
  ...
  async updateStaffRole(input: UpdateStaffRoleInput) {
    try {
      ...
      Logger.error('Error updating staff role', { input, error: error instanceof Error ? { name: error.name, message: error.message, stack: error.stack } : undefined });
      throw error;
    }
  }
  ...
  async removeStaff(userId: string, restaurantId: string, removedBy?: string) {
    try {
      ...
      Logger.error('Error removing staff', { userId, restaurantId, error: error instanceof Error ? { name: error.name, message: error.message, stack: error.stack } : undefined });
      throw error;
    }
  }
  ...
  async getRestaurantSettings(restaurantId: string) {
    try {
      ...
      Logger.error('Error fetching restaurant settings', { restaurantId, error: error instanceof Error ? { name: error.name, message: error.message, stack: error.stack } : undefined });
      throw error;
    }
  }
  ...
  async updateRestaurantSettings(input: UpdateSettingsInput) {
    try {
      ...
      Logger.error('Error updating restaurant settings', { input, error: error instanceof Error ? { name: error.name, message: error.message, stack: error.stack } : undefined });
      throw error;
    }
  }
  ...
  async updateRestaurantInfo(
    ...
    try {
      ...
      Logger.error('Error updating restaurant info', { restaurantId, data, error: error instanceof Error ? { name: error.name, message: error.message, stack: error.stack } : undefined });
      throw error;
    }
  }
