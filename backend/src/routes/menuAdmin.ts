...
export async function menuAdminRoutes(fastify: FastifyInstance) {
  ...
  fastify.get<{
    ...
    try {
      ...
      Logger.error('Failed to fetch menu items', { error: error instanceof Error ? { name: error.name, message: error.message, stack: error.stack } : undefined });
  ...
  fastify.get<{
    ...
    try {
      ...
      Logger.error('Failed to fetch menu item', { error: error instanceof Error ? { name: error.name, message: error.message, stack: error.stack } : undefined });
  ...
  fastify.post<{
    ...
    try {
      ...
      Logger.error('Failed to create menu item', { error: error instanceof Error ? { name: error.name, message: error.message, stack: error.stack } : undefined });
  ...
  fastify.patch<{
    ...
    try {
      ...
      Logger.error('Failed to update menu item', { error: error instanceof Error ? { name: error.name, message: error.message, stack: error.stack } : undefined });
      return reply.code(400).send({
        success: false,
  ...
  fastify.delete<{
    ...
    try {
      ...
      Logger.error('Failed to delete menu item', { error: error instanceof Error ? { name: error.name, message: error.message, stack: error.stack } : undefined });
      return reply.code(400).send({
        success: false,
  ...
  fastify.post<{
    ...
    try {
      ...
      Logger.error('Failed to attach modifier groups', { error: error instanceof Error ? { name: error.name, message: error.message, stack: error.stack } : undefined });
      return reply.code(400).send({
        success: false,
  ...
  fastify.get<{
    ...
    try {
      ...
      Logger.error('Failed to fetch categories', { error: error instanceof Error ? { name: error.name, message: error.message, stack: error.stack } : undefined });
      return reply.code(500).send({
        success: false,
  ...
  fastify.post<{
    ...
    try {
      ...
      Logger.error('Failed to create category', { error: error instanceof Error ? { name: error.name, message: error.message, stack: error.stack } : undefined });
      return reply.code(400).send({
        success: false,
  ...
  fastify.patch<{
    ...
    try {
      ...
      Logger.error('Failed to update category', { error: error instanceof Error ? { name: error.name, message: error.message, stack: error.stack } : undefined });
      return reply.code(400).send({
        success: false,
  ...
  fastify.delete<{
    ...
    try {
      ...
      Logger.error('Failed to delete category', { error: error instanceof Error ? { name: error.name, message: error.message, stack: error.stack } : undefined });
      return reply.code(400).send({
        success: false,
  ...
  fastify.post<{
    ...
    try {
      ...
      Logger.error('Failed to reorder categories', { error: error instanceof Error ? { name: error.name, message: error.message, stack: error.stack } : undefined });
      return reply.code(400).send({
        success: false,
  ...
  fastify.get<{
    ...
    try {
      ...
      Logger.error('Failed to fetch modifier groups', { error: error instanceof Error ? { name: error.name, message: error.message, stack: error.stack } : undefined });
      return reply.code(500).send({
        success: false,
  ...
  fastify.get<{
    ...
    try {
      ...
      Logger.error('Failed to fetch modifier group', { error: error instanceof Error ? { name: error.name, message: error.message, stack: error.stack } : undefined });
      return reply.code(404).send({
        success: false,
  ...
  fastify.post<{
    ...
    try {
      ...
      Logger.error('Failed to create modifier group', { error: error instanceof Error ? { name: error.name, message: error.message, stack: error.stack } : undefined });
      return reply.code(400).send({
        success: false,
  ...
  fastify.patch<{
    ...
    try {
      ...
      Logger.error('Failed to update modifier group', { error: error instanceof Error ? { name: error.name, message: error.message, stack: error.stack } : undefined });
      return reply.code(400).send({
        success: false,
  ...
  fastify.delete<{
    ...
    try {
      ...
      Logger.error('Failed to delete modifier group', { error: error instanceof Error ? { name: error.name, message: error.message, stack: error.stack } : undefined });
      return reply.code(400).send({
        success: false,
  ...
  fastify.post<{
    ...
    try {
      ...
      Logger.error('Failed to create modifier', { error: error instanceof Error ? { name: error.name, message: error.message, stack: error.stack } : undefined });
      return reply.code(400).send({
        success: false,
  ...
  fastify.patch<{
    ...
    try {
      ...
      Logger.error('Failed to update modifier', { error: error instanceof Error ? { name: error.name, message: error.message, stack: error.stack } : undefined });
      return reply.code(400).send({
        success: false,
  ...
  fastify.delete<{
    ...
    try {
      ...
      Logger.error('Failed to delete modifier', { error: error instanceof Error ? { name: error.name, message: error.message, stack: error.stack } : undefined });
      return reply.code(400).send({
        success: false,
  ...
  fastify.post<{
    ...
    try {
      ...
      Logger.error('Failed to reorder modifiers', { error: error instanceof Error ? { name: error.name, message: error.message, stack: error.stack } : undefined });
      return reply.code(400).send({
        success: false,
