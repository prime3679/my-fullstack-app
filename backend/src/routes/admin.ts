...
export async function adminRoutes(fastify: FastifyInstance) {
  ...
  fastify.get<{
    ...
    try {
      ...
      Logger.error('Failed to fetch staff', { error: error as Error });
  ...
  fastify.post<{
    ...
    try {
      ...
      Logger.error('Failed to invite staff', { error: error as Error });
  ...
  fastify.patch<{
    ...
    try {
      ...
      Logger.error('Failed to update staff role', { error: error as Error });
      return reply.code(400).send({
        success: false,
  ...
  fastify.delete<{
    ...
    try {
      ...
      Logger.error('Failed to remove staff', { error: error as Error });
      return reply.code(400).send({
        success: false,
  ...
  fastify.get<{
    ...
    try {
      ...
      Logger.error('Failed to fetch settings', { error: error as Error });
      return reply.code(500).send({
        success: false,
  ...
  fastify.patch<{
    ...
    try {
      ...
      Logger.error('Failed to update settings', { error: error as Error });
      return reply.code(400).send({
        success: false,
  ...
  fastify.patch<{
    ...
    try {
      ...
      Logger.error('Failed to update restaurant info', { error: error as Error });
      return reply.code(400).send({
        success: false,
  ...
  fastify.get<{
    ...
    try {
      ...
      Logger.error('Failed to fetch permissions', { error: error as Error });
      return reply.code(500).send({
        success: false,
  ...
  fastify.get('/roles', async (request, reply) => {
    try {
      ...
      Logger.error('Failed to fetch roles', { error: error as Error });
      return reply.code(500).send({
        success: false,
